...
IF ~Class(Player1,PALADIN_ALL) !Kit(Player1,BLACKGUARD)~ + BFSImoenPaladin 
...
++ ~(laugh) Don't remind me!~ + BFSImoenDruid2
++ ~You hold fonder memories of him than I do.~ + BFSImoenNotFond
END

IF ~~ BFSImoenDruid1
SAY ~I felt a yawn coming on just from hearing you say that...~
IF ~~ + BFSImoenDruid3
END
...
IF ~~ BFSImoenCleric1
SAY ~He sure did, didn’t he? Would've been nice of him to tell us about it. Though...given how everything's turned out. Maybe's it's a blessing that we didn't know sooner. That we had those carefree years to shape us beforehand.~
IF ~~ + BFSImoenWrapThisUpPlz
END
...
IF ~~ BFSImoenMonk1
SAY ~There you go again. Being all sensible. But the fact that he made the attempt, despite how awkward he could be, that was what mattered.~
IF ~~ + BFSImoenWrapThisUpPlz
END
...
= ~I haven't had a chance to return the favour. We'll get there and then I will. Rescue you, that is.~ 
IF ~~ + BFSImoenWraithEnd
END
...
IF ~~ BFSImoenNotFond
SAY ~Then there's nothing more to say. Other than...I'm glad you're here, <CHARNAME>, you're the best <PRO_BROTHERSISTER> I could have asked for.~
IF ~~ + BFSImoenWraithEnd
END
